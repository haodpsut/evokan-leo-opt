...
(Fig.~\ref{fig:pareto2}); the bandit-controlled \texttt{fedkan\_opt} selects an
operating point that approaches the dense-KAN accuracy at a fraction of the
uplink, automating the choice an operator would otherwise tune by hand.
...
sample efficiency, extrapolation, and transparency rather than asymptotic capacity. Our oracle and channel model are simulation-based; closing
